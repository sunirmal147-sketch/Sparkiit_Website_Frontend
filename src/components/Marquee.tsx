    ...
    return (
        <section className="py-12 border-y border-white/5 overflow-hidden bg-[#050505] flex flex-col gap-12">
            <div className="max-w-7xl mx-auto px-6 md:px-20 mb-4 text-center">
                <span className="text-[#00875a] font-bold uppercase tracking-[0.2em] text-xs md:text-sm border border-[#00875a]/20 px-10 py-3.5 rounded-full backdrop-blur-sm shadow-[0_0_20px_rgba(0,135,90,0.1)]">
                    {title}
                </span>
            </div>
