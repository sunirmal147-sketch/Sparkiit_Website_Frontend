    ...
    return (
        <div className="space-y-12">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
                <div>
                    <h1 className="text-4xl font-bold tracking-tight uppercase">Project <span className="text-[#a8e03e]">Submissions</span></h1>
                    <p className="text-gray-400 mt-2">Submit and track your practical course assignments.</p>
                </div>
                <button className="px-8 py-4 bg-white text-black font-black text-xs uppercase rounded-2xl hover:bg-[#a8e03e] transition-colors">
                    New Submission
                </button>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                {mockProjects.map((project, i) => (
                    <motion.div
                        ...
                        className="bg-[#0a0a0a] border border-white/5 rounded-[2rem] p-8 group hover:border-[#a8e03e]/20 transition-all"
                    >
                        <div className="flex justify-between items-start mb-8">
                            ...
                            <span className={`px-4 py-2 rounded-full text-[10px] font-black uppercase tracking-widest flex items-center gap-2 ${
                                project.status === 'reviewed' ? 'bg-[#a8e03e]/10 text-[#a8e03e]' : 'bg-yellow-500/10 text-yellow-500'
                            }`}>
                        ...
                        <h3 className="text-2xl font-bold uppercase tracking-tight mb-2 group-hover:text-[#a8e03e] transition-colors">{project.title}</h3>
                        ...
                        <div className="flex items-center justify-between pt-6 border-t border-white/5">
                            ...
                            {project.grade && (
                                <div className="text-right">
                                    ...
                                    <p className="text-2xl font-black text-[#a8e03e]">{project.grade}</p>
                                </div>
                            )}
                        </div>
                    </motion.div>
                ...
                <div className="flex flex-col items-center justify-center p-8 border-2 border-dashed border-white/5 rounded-[2rem] min-h-[300px] text-center">
                    ...
                    <p className="text-gray-500 font-bold uppercase tracking-widest text-sm leading-relaxed">
                        ...
                        <span className="text-[#a8e03e] hover:underline cursor-pointer">Submit your next project</span>
                    </p>
                </div>
            </div>
        </div>
