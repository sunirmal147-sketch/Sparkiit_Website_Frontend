...
import { Check, Calendar, Clock, User, ChevronRight, ArrowLeft } from "lucide-react";
...
export default function EnrollPage() {
    ...
    const confirmBooking = async () => {
        ...
        // Simulate API call to /api/public/bookings
        try {
                ...
                <div className="max-w-7xl mx-auto">
                    <header className="mb-16">
                        ...
                        <h1 className="text-4xl md:text-6xl font-bold uppercase tracking-tighter">
                            ...
                            {step === 4 && <TextReveal text="Booking Confirmed" />}
                        </h1>
                    </header>
                            ...
                            >
                                ...
                                <div className="bg-white/5 border border-white/10 p-10 rounded-3xl space-y-8">
                                    ...
                                    <div className="border-t border-white/10 pt-8 flex justify-between items-center">
                                        ...
                                        <PremiumButton 
                                            text={bookingLoading ? "Processing..." : "Confirm Booking"} 
                        ...
                        {step === 4 && (
                            ...
                            >
                                ...
                                <p className="text-gray-400 text-lg mb-12 px-6">
                                    Your slot for <strong>{selectedCourse?.title}</strong> has been reserved. <br />
