...
export default function CollaboratorsPage() {
    ...
    const handleLogoUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        formData.append("uploadType", "collaborators");
    ...
    const handleSave = async () => {
        setSaving(true);
        const url = editingId ? `${API_BASE}/collaborators/${editingId}` : `${API_BASE}/collaborators`;
            ...
            {isFormOpen && (
                <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-6">
                    <div className="bg-[#141414] border border-white/10 p-8 rounded-2xl w-full max-w-md shadow-2xl">
                        ...
                        <label className="text-[10px] font-bold text-white/40 uppercase tracking-widest mb-2 block">Collaborator Name</label>
                        <input 
                            style={inputStyle}
                            value={form.name}
