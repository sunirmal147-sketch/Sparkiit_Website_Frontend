...
export default function AdminDashboard() {
    ...
    const websiteActions = [
        ...
        { title: "FEATURED IN", desc: "Featured in Company Logos", icon: Copyright, link: "/admin/brands", color: "#a855f7", permissionKey: "COLLABORATORS" },
        { title: "COLLABORATORS", desc: "Marquee Partner Logos", icon: Users, link: "/admin/collaborators", color: "#ec4899", permissionKey: "COLLABORATORS" },
