        ...
        try {
            ...
            if (data.success) {
                ...
                setTimeout(() => {
                    setIsFormOpen(false);
                    setEditingId(null);
                    setCurrentService({ title: "", description: "", category: "", thumbnailUrl: "", link: "", order: 0 });
                    setStatus(null);
                }, 1500);
            } else {
                        ...
                        <div key={service._id} style={{
                            ...
                            <div>
                                <h3 style={{ fontSize: 18, fontWeight: 700, color: "#fff", marginBottom: 12, display: "flex", alignItems: "center", gap: 10 }}>
                                    {service.title}
                                    <div style={{ fontSize: 10, background: "rgba(0,135,90,0.1)", color: "#00875a", padding: "2px 8px", borderRadius: 4, textTransform: "uppercase" }}>{service.category}</div>
                ...
                <div style={{
                    ...
                    >
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
                            <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
                                <InputField label="Title" value={currentService.title} onChange={(val: string) => setCurrentService({...currentService, title: val})} placeholder="Educational Platform 1" />
                                <InputField label="Category" value={currentService.category} onChange={(val: string) => setCurrentService({...currentService, category: val})} placeholder="E-LEARNING" />
                                <InputField label="Image URL" value={currentService.thumbnailUrl} onChange={(val: string) => setCurrentService({...currentService, thumbnailUrl: val})} placeholder="https://example.com/image.jpg" />
                            </div>
