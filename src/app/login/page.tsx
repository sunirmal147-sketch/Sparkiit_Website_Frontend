...
export default function LoginPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const res = await fetch(`${API_BASE_URL}/api/public/auth/login`, {
                method: "POST",
        ...
        >
            ...
            >
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <motion.div variants={itemVariants}>
                        <div className="flex justify-between items-center mb-2 pl-1 pr-1">
                            ...
                            <Link href="/forgot-password" className="text-[10px] font-black text-[#00875a] hover:text-[#00a86b] uppercase tracking-widest transition-all">
                                Forgot Password?
                            </Link>
                        </div>
                        <input 
                ...
                <motion.p variants={itemVariants} className="text-center mt-8 text-sm text-white/40">
                    Don't have an account? <Link href="/signup" className="text-[#00875a] font-bold hover:text-[#00a86b] transition-colors">Sign Up</Link>
                </motion.p>
            </motion.div>
        </div>
    );
